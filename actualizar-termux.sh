...
for required in ofbackup ofbackup_cli.py requirements-termux.txt backend frontend; do
...
mkdir -p "$PREFIX_BIN"
install -m 755 "$SOURCE_DIR/ofbackup" "$PREFIX_BIN/of"
install -m 755 "$SOURCE_DIR/ofbackup" "$PREFIX_BIN/ofbackup"
